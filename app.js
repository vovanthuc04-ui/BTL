...
function logout() {
    ...
    // Tự động phát hiện đường dẫn đúng về index.html
...
function handleAddToCart(productId, productName, productPrice, productImage) {
    ...
    window.currentProductImage = productImage;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Search functionality - TỰ ĐỘNG PHÁT HIỆN ĐƯỜNG DẪN
        ...
        searchBtn.addEventListener('click', () => {
            ...
            if (query) {
                ...
                if (currentPath.includes('/frontend/pages/')) {
                    ...
                    productsPath = 'frontend/pages/products.html';
                }
